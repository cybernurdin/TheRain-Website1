      ...
      <section className="container-page pb-16">
        <div className="card rounded-3xl p-6 text-center md:p-8">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-sm leading-7 text-slate-300">
            {locale === "fr" ? (
              <>
                therain.cm est le site officiel de <BrandName />. Cette page est disponible en français et en anglais avec des URLs canoniques propres.
              </>
            ) : (
              <>
                therain.cm is the official website of <BrandName />. This page is available in English and French with clean canonical URLs.
              </>
            )}
          </p>
