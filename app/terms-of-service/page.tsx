...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://therain.cm/terms-of-service" },
  openGraph: {
    title: "Terms of Service — TheRain",
    description: "Read TheRain’s terms of service for riders, drivers, and transport users in Cameroon.",
    url: "https://therain.cm/terms-of-service",
    images: [{ url: "https://therain.cm/images/bg.jpg", width: 1200, height: 630, alt: "TheRain terms of service" }]
  },
  twitter: {
