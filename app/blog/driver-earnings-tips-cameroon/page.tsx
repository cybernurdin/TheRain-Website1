...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://therain.tech/blog/driver-earnings-tips-cameroon" },
  openGraph: {
    title: "5 Tips to Earn More as a TheRain Driver in Cameroon",
    description:
      "Practical tips for TheRain drivers to improve ratings, choose better routes, and grow income on the platform.",
    url: "https://therain.tech/blog/driver-earnings-tips-cameroon",
    type: "article",
    images: [{ url: "https://therain.tech/images/blog_driver.jpg", width: 1200, height: 630, alt: "TheRain driver earning tips in Cameroon" }]
  },
  twitter: {
    card: "summary_large_image",
    title: "5 Tips to Earn More as a TheRain Driver in Cameroon",
    description: "Practical tips for TheRain drivers to improve ratings and grow income on the platform.",
    images: ["https://therain.tech/images/blog_driver.jpg"]
  }
};
